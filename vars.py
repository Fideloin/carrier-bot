...
ABOUT_TEXT = "Бот был написал в чтобы занять руки и для помощи беларусам Малаги и окрестностей." \
             ...
             "других стран.\n\n" \
             "Исходный код бота можно найти по ссылке - https://github.com/Fideloin/carrier-bot . Автор приветствует " \
             ...
             "ВАЖНО! Чтобы ссылка выше работала, человек оставивший контакт должен разрешить пересылку своих сообщений. " \
             "По дефолту эта опция включена, но если вы её меняли и забыли, то проверить можно в настройках Телеграм: " \
             ...
             "либо добавьте контакт бота в список исключений. Доступа ни к каким сообщениям бот не имеет, функция нужна " \
